    ...
    <>
      {accountLock ? (
        <div
          ...
          role="alert"
        >
          <span className="font-medium">Account is locked!</span> Please try
          again after.{Math.ceil(lockoutDuration / 60000)} minutes.
        </div>
      ) : (
        <div>
          {load ? (
            ...
            <>
              <div className="min-h-screen text-gray-900 flex justify-center flex-col md:flex-row">
                <LeftSideBlock />
                <LoginForm
